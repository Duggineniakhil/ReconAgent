...
4. Before committing ANY match, call check_duplicate_ref on the reference number you're
   about to use. A reused reference is a red flag even if amount and name look right —
   flag it as an exception rather than commit, and explain why in your reasoning.
